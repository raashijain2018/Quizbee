...
<li class="nav-item active">
  <a class="nav-link ali"  style="color:white">Register<span class="sr-only">(current)</span></a>
</li>
</ul>
</div>
</div>
...
<div class="container-fluid">
  ...
  <div class="row mirinda">
    ...
    <div class="col-md-4 col-11 pads">
      ...
      <p>
        Math Bee is a math competition where students from grade 3- 10 compete in three categories.
...
For the 1st round answers will be corrected within a specified time period and  the list of 20% of registered participants  will be eligible to qualify for the second round.
<ul>
  <li>
  The competition is open to all the internals willing to participate . Criterion for the internal participants might vary from the category wise distribution.
</li>
  <li>
