    ...
    <div class="container-fluid-hmmm">
      <h1 style="background-color: none; margin-bottom: 0px; padding-bottom: 0px;" class="inst text-center no">Instructions</h1>
       <div class="yes">
        ...
        <p>2. There will be 5 questions in total and each question carries equal marks.</p>
        <p>3. The maximum time duration is 2 minutes.</p>
        ...
        <p class="plast">quiz will be given priority. So, it is adviced to submit the quiz as soon as you finish.</p>
         <br>
        ...
        <br>
        <?php $res=mysqli_query($link,"select * from exam_category where id='12'");
